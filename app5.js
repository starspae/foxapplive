...
var colour = ['GREEN', 'RED', 'BLUE', 'BLACK', 'ORANGE', 'PURPLE'];
...
var img=document.getElementById("greensplat");
ctx1.drawImage(img,10,10);

var img=document.getElementById("redsplat");
ctx2.drawImage(img,10,10);

var img=document.getElementById("bluesplat");
ctx3.drawImage(img,10,10);

var img=document.getElementById("blacksplat");
ctx4.drawImage(img,10,10);

var img=document.getElementById("orangesplat");
ctx5.drawImage(img,10,10);

var img=document.getElementById("purplesplat");
...
var coloure = ['GREEN', 'RED', 'BLUE', 'BLACK', 'ORANGE', 'PURPLE'];
